    ...
    <div class="panel">
        ...
        <form action="{{ route('users.store') }}"  method="post" class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    <label>Name</label>
                    <input type="text" name="name" placeholder="Enter User Name" class="form-input"
            ...
            <div>
                ...
                <div class="flex" x-data="hiddenPass">
                    <input :type="type" name="password" placeholder="Enter Password"
                        class="form-input rounded-r-none" wire:model.defer="password" required>
            ...
            <div>
                ...
                <div class="flex" x-data="hiddenPass">
                    <input :type="type" name="password_confirmation"
                        placeholder="Confirm The Password" class="form-input rounded-r-none" required>
                    <div class="bg-[#eee] flex justify-center items-center ltr:rounded-r-md rtl:rounded-l-md px-3 font-semibold border ltr:border-l-0 rtl:border-r-0 border-[#e0e6ed] dark:border-[#17263c] dark:bg-[#1b2e4b]"
                        @click="toggleVisibility">
                        <template x-if="hide">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
