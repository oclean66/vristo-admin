<div class="flex min-h-screen items-center justify-center dark:bg-dark-dark-light">
    <div class="w-full lg:w-1/2 h-full" x-data="comingsoon">
        <div class="max-w-[480px] mx-auto p-5 md:p-10">
            <h4 class="text-primary text-2xl md:text-4xl font-bold mb-2">{{__('Welcome')}}</h4>
            <p class="text-base font-bold mb-10 text-white-dark">{{__('We will be here in a shortwhile')}}....</p>
            ...
            <h3 class="text-xl font-bold mb-10 text-center">{{__('Subscribe to get notified')}}</h3>
            <form class="mb-10" @submit.prevent="window.location='/'">
                <div class="relative max-w-[580px] mx-auto">
                    ...
                    <button type="submit"
                        class="btn btn-primary absolute top-0 ltr:right-0 rtl:left-0 py-2.5 rounded-bl-3xl">{{__('Subscribe')}}</button>
                </div>
            </form>
            ...
            <p class="text-center"> © 2023 - TERRAKION</p>
        </div>
    </div>
    <div class="bg-[#060818] w-1/2 min-h-screen  lg:flex items-center justify-center p-4">
        <img class="bg-white rounded-full w-2/3" src="{{asset('assets/images/logo.svg')}}" alt="coming_soon"
...
<script>
    document.addEventListener("alpine:init", () => {
        ...
        Alpine.init();
        Alpine.store("comingsoon").setTimerDemo1();
    });
</script>