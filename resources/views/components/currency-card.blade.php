<div class="overflow-hidden panel bg-gradient-to-r from-cyan-600 to-cyan-500">
    <div class="flex justify-between">
        <div class="ltr:mr-1 rtl:ml-1 text-xl font-extrabold">{{$attributes['title']}}</div>
    </div>
    <div class="flex items-center mt-5">
        <div class="text-4xl font-bold ltr:mr-3 rtl:ml-3"> {{$attributes['price']}} </div>
    </div>
    <div class="flex items-center font-semibold text-lg mt-5">
        <svg class="group-hover:!text-primary mx-1" width="20" height="20"
